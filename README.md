...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="#">ProPharma</a>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-4">
        <img src="pharm logo.jpg" class="img-fluid" alt="Pharmacy Image">
      </div>
    </div>
  </div>
  <body background="pharm 2.jpg" style="background-repeat: no-repeat; background-size: cover;">
  <br>
  <br>
  <br>
  <br>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 ProPharma. All rights reserved. BY SUDHAKARAN S</p>
  </footer>
...
<body>
  ...
  <body background="pharm 4.png" style="background-repeat: no-repeat; background-size: cover;"></body>
  <!-- Footer -->
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Products - ProPharma</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="proimg1.jpg" class="card-img-top" alt="Product 1" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="proimg2.jpeg" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="proimg3.jpg" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="proimg4.jpg" class="card-img-top" alt="Product 3" width="200" height="200">
            <div class="card-body">
  ...
  <!-- Footer -->
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 ProPharma. All rights reserved. SUDHAKARAN S</p>
  </footer>
  <body background="pharm 3.jpg" style="background-repeat: no-repeat; background-size: cover;">
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Contact Us - ProPharma</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <address>
          ...
          MOUNT ROAD,CHENNAI<br>
          India, 600007<br><br>
          <strong>Email:</strong><br>
          sudhakar@propharma.com<br><br>
...
![alt text](<Screenshot 2024-05-10 210102.png>)
![alt text](<Screenshot 2024-05-10 210144.png>)
![alt text](<Screenshot 2024-05-10 210206.png>)
![alt text](<Screenshot 2024-05-10 210226.png>)
